...
@Query("SELECT t FROM Train t " +
        ...
        "JOIN ts2.station s2 " +
        "JOIN t.coaches c " +
        "JOIN c.seats se " +  // Assuming seats is mapped with coaches
        ...
        "AND c.coachType = :coachType " +              // Check for coach type
        "AND se.seatCategory = :seatCategory")
Page<Train> findTrains(@Param("fromStationCode") String fromStationCode,
